...
Method is used to assign an tag to the principal video for synchronization purposes.

### `setPeripheralVideoTag`

<PlatformsList types={['iOS']} />

Method is used to assign an tag to the peripheral video for synchronization purposes.
