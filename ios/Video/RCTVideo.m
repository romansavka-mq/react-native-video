...
static NSString *const audioTrack = @"audioTrack";
            ...
            if (_playerItem.status == AVPlayerItemStatusReadyToPlay) {
                ...
                if (self.onVideoLoad && _videoLoadStarted) {
                    ...
                    self.onVideoLoad(@{@"duration": [NSNumber numberWithFloat:duration],
                                       ...
                                       @"audioTracks": [self getAudioTracksInfo],
                        ...
                        masterModel: (M3U8PlaylistModel *) masterModel
{
    ...
    if (current != nil) {
        ...
        {
            M3U8ExtXMedia *info = [masterModel.masterPlaylist.xMediaList.audioList xMediaAtIndex:i];
            if (info != nil) {
                [mediaList addObject:info];
            }
        }
