...
RCT_EXPORT_VIEW_PROPERTY(masterVideo, NSNumber);
RCT_EXPORT_VIEW_PROPERTY(slaveVideo, NSNumber);
...
RCT_EXTERN_METHOD(getCurrentTime
                  : (nonnull NSNumber*)rectTag reactTag
                  : (nonnull NSNumber *)commandId commandId)
